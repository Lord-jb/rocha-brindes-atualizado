...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate(_a || (_a = __template([' <script type="application/ld+json">', "<\/script> ", " "])), unescapeHTML(schema), renderComponent($$result2, "Home", null, { "client:only": "solid-js", "client:component-hydration": "only", "client:component-path": "/home/jorge/apps/rocha-brindes-atualizado/src/components/Home.solid", "client:component-export": "default" })) })}`;
}, "/home/jorge/apps/rocha-brindes-atualizado/src/pages/index.astro", void 0);

const $$file = "/home/jorge/apps/rocha-brindes-atualizado/src/pages/index.astro";
const $$url = "";
